...
const STAGES = ['idle', 'selected', 'uploading', 'processing', 'done', 'error']
...
export default function UploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setStage('uploading')
      await uploadDataset(formData, (pct) => setProgress(pct))
              ...
              {stage === 'done' ? (
                ...
                >
                  ...
                  <h3 style={{ fontSize: '16px', fontWeight: 600, marginBottom: '8px' }}>
                    {stage === 'uploading' ? 'Uploading dataset...' : 'Running ML analysis...'}
                  </h3>
                  <p style={{ color: 'var(--text-muted)', fontSize: '13px', marginBottom: '24px' }}>
                    {stage === 'uploading'
                      ? 'Sending data to the server'
                      : 'XGBoost is scoring your customers'}
                  </p>
                  {stage === 'uploading' && (
                    <div>
                      <div style={{
                ...
                <motion.div key="upload-box" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      textAlign: 'center', cursor: stage === 'idle' ? 'pointer' : 'default',
                      transition: 'all 0.2s',
                    }}
                  >
                    <input
