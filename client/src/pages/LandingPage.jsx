...
const features = [
  ...
  {
    icon: <Lightbulb size={20} color="#a855f7" />,
    title: "Strategic Insights",
    desc: "Instantly generate LLM-powered key findings and actionable recommendations based on your overall dataset analytics.",
    tag: "LLM AI",
  },
];
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)" }}>
      ...
      <div
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(ellipse, rgba(79,142,247,0.12) 0%, transparent 70%)",
          zIndex: 0,
          pointerEvents: "none",
        }}
      />
          ...
          <div style={{ maxWidth: "760px", textAlign: "center" }}>
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg, #4f8ef7 0%, #7c6ff7 50%, #a855f7 100%)",
            ...
            >
              Upload your customer dataset and instantly get AI-powered churn
              predictions, risk segmentation, and retention analytics.
            </motion.p>
            ...
            {[
              {
                ...
                desc: "Drop a CSV file with your customer data. Supports the standard telecom churn dataset format.",
              },
              {
                n: "02",
                title: "AI analyzes every customer",
                desc: "Our XGBoost model scores each customer with a precise churn probability and risk tier.",
              },
              {
                n: "03",
                title: "Get Strategic Insights",
                desc: "Instantly receive LLM-generated key findings and recommended actions based on your overall dataset analytics.",
              },
              {
                n: "04",
                title: "Act on the insights",
                desc: "Use the dashboard to find high-risk segments, understand churn drivers, and plan retention campaigns.",
              },
            ].map((step, i) => (
              <motion.div
                key={i}
        ...
        <section style={{ padding: "80px 24px 120px", textAlign: "center" }}>
          <motion.div
            ...
            style={{
              ...
              border: "1px solid var(--border)",
              background:
                "linear-gradient(135deg, rgba(79,142,247,0.05) 0%, rgba(124,58,237,0.05) 100%)",
            }}
          >
            <TrendingDown
              size={36}
            ...
            >
              Upload your dataset and get AI-powered insights in under 60
              seconds.
            </p>
            <Link
              to="/upload"
