...
const STAGE_TEXT = {
  uploading: {
    ...
    sub: "Sending data to the server",
  },
  ml: {
    title: "Running ML analysis...",
    sub: "XGBoost is scoring your customers",
  },
  insights: {
    title: "Generating AI insights...",
    sub: "Llama 3.3 is analyzing patterns · ~10 seconds",
  },
...
export default function UploadPage() {
  ...
  const isProcessing = ["uploading", "ml", "insights", "finishing"].includes(
    stage,
  );
